(() => {
  ...
  var Ie = (e, t, n) =>
      t in e
        ...
        : (e[t] = n),
    R = (e, t) => {
      for (var n in t || (t = {})) it.call(t, n) && Ie(e, n, t[n]);
      if (pe) for (var n of pe(t)) st.call(t, n) && Ie(e, n, t[n]);
      return e;
    },
    De = (e, t) => Tn(e, vn(t));
  var lt = (e, t) => {
    ...
    if (e != null && pe)
      for (var r of pe(e)) t.indexOf(r) < 0 && st.call(e, r) && (n[r] = e[r]);
    return n;
  };
  var P = (e, t, n) => (Ie(e, typeof t != "symbol" ? t + "" : t, n), n);
  var C = (e, t, n) =>
    new Promise((r, o) => {
      var a = (l) => {
          try {
  ...
  function Ne(e) {
    ...
    if (e) {
      ...
      if (n) return ((n = R({}, n)), delete n.children, n);
    }
  }
  var te = "data-fg-";
  function ze(e, t) {
  ...
  function ct(e) {
    ...
    for (let [n, r] of Object.entries(e)) {
      if (!kn(n) || typeof r != "string") continue;
      let o = n.split("-");
      if (o.length === 3) {
        let a = o[2],
          i = ze(a, r);
  ...
  function Re(e) {
    ...
    if (t) {
      ...
      for (let r = 0; r < e.attributes.length; r++) {
        ...
        if (o != null && o.name.startsWith(te)) {
          let a = o.name.split("-")[2],
            i = ze(a, o.value);
          i && n.push(i);
        }
      }
  ...
  var me = class {
    constructor() {
      P(this, "families", new Map());
      P(this, "processedUsages", new Set());
      P(this, "unavailable", new Set());
      P(this, "_canvas", null);
      P(this, "_ctx", null);
    }
    get ctx() {
    ...
    checkFontAvailable(t, n, r, o) {
      ...
      for (let c of l) {
        this.ctx.font = `${s} ${r} ${o} ${i} ${c}`;
        let u = this.ctx.measureText(a).width;
        this.ctx.font = `${s} ${r} ${o} ${i} "${t}", ${c}`;
    ...
    collectWebFontFaces() {}
    addFontFamily(t, n, r, o, a) {
      let i = Pn(t);
      for (let s of i) {
        let l = s.toLowerCase(),
          c = `${l}|${n}|${r}|${o}`;
        if (this.unavailable.has(c)) continue;
        if (this.families.has(l)) {
          this.addUsage(l, n, r, o, a);
          return;
        }
        if (!this.checkFontAvailable(s, n, r, o)) {
          this.unavailable.add(c);
          continue;
        }
        (this.families.set(l, { familyName: s, faces: [], usages: [] }),
          this.addUsage(l, n, r, o, a));
        return;
      }
    }
    addUsage(t, n, r, o, a) {
      let i = `${t}|${n}|${r}|${o}|${a}`;
      if (this.processedUsages.has(i)) return;
      this.processedUsages.add(i);
  ...
  function ut(e, t, n) {
    var s, l, c, u;
    let r = (s = t.fontWeight) != null ? s : "400",
      o = t.fontStyle === "italic" ? "italic" : "normal",
      a = (l = t.fontStretch) != null ? l : "100%",
      i = (c = t.fontSize) != null ? c : "16px";
    n.addFontFamily((u = t.fontFamily) != null ? u : "Times", a, o, r, i);
  }
  function An(e) {
  ...
  function Pn(e) {
    ...
    for (; (r = n.exec(e)) !== null; ) {
      let s =
        (i = (a = (o = r[1]) != null ? o : r[2]) != null ? a : r[3]) == null
          ? void 0
          : i.trim();
      s && t.push(s);
    }
  ...
  function dt(e, t, n) {
    (Dn(e, n), Nn(e, n), In(n, t));
  }
  function In(e, t) {
    var r;
    let n =
      (r = t.backgroundImage) == null ? void 0 : r.matchAll(/url\("(.*?)"\)/g);
    if (n) for (let [o, a] of n) e.addImage(a);
  }
  function Dn(e, t) {
  ...
  function Nn(e, t) {
    e instanceof HTMLVideoElement &&
      ...
      e.currentSrc && !zn(e) && t.addVideo(e));
  }
  function zn(e) {
    return e.poster
  ...
  var ge = class {
      constructor(t) {
        P(this, "promises", new Map());
        P(this, "rasterizedId", 0);
        P(this, "options");
        this.options = t;
      }
      addPromise(t, n) {
      ...
      addImage(t) {
        ...
        let n =
          this.options.skipRemoteAssetSerialization && pt(t)
      ...
      getBlobMap() {
        return C(this, null, function* () {
          let t = new Map();
          for (let [n, r] of this.promises.entries()) {
            let o = yield r;
            t.set(n, o);
          }
          return t;
    ...
    Rn = new Set(["image/avif", "image/heif", "image/heic"]);
  function Mn(e) {
    return C(this, null, function* () {
      let t = yield fetch(e);
      if (!t.ok) throw new Error(`Failed to fetch image: ${e} - ${t.status}`);
      let n = yield t.blob();
      return (Rn.has(n.type) && (n = yield Ln(n)), { url: e, blob: n });
    });
  }
  function Ln(e) {
    return C(this, null, function* () {
      ...
      try {
        ...
        return (o.drawImage(n, 0, 0), yield Oe(r));
      } finally {
  ...
  function jn(e) {
    return C(this, null, function* () {
      ...
      if (On(t) || e.crossOrigin !== null) return null;
      ...
      return (
        ...
        new Promise((o, a) => {
          ...
          (n.addEventListener("error", w),
            i === 0
              ? ((s = !0),
                (c = n.requestVideoFrameCallback(m)),
                n
                  .play()
                  .then(() => n.pause())
                  .catch(w))
          ...
          function d() {
            ((n.currentTime = i),
              n.addEventListener("seeked", g, { once: !0 }),
              (c = n.requestVideoFrameCallback(m)));
          }
          function m() {
            ((l = !0), y());
          ...
          function S() {
            (clearTimeout(u),
              ...
              c !== null && n.cancelVideoFrameCallback(c));
          }
          function w() {
            var F, E;
            let b = new Error(
              `Video error: code: ${(F = n.error) == null ? void 0 : F.code}, message: ${(E = n.error) == null ? void 0 : E.message} (readyState: ${n.readyState})`,
            );
            (S(), Le(n), a(b));
          }
          function f() {
            (S(), Le(n), a(new $("Video loading timeout", "VIDEO_TIMEOUT")));
          }
        })
      );
    });
  ...
  var mt;
  (function (e) {
    ((e[(e.FunctionComponent = 0)] = "FunctionComponent"),
      (e[(e.ClassComponent = 1)] = "ClassComponent"),
      (e[(e.HostRoot = 3)] = "HostRoot"),
      (e[(e.HostPortal = 4)] = "HostPortal"),
      (e[(e.HostComponent = 5)] = "HostComponent"),
      (e[(e.HostText = 6)] = "HostText"),
      (e[(e.Fragment = 7)] = "Fragment"),
      (e[(e.Mode = 8)] = "Mode"),
      (e[(e.ContextConsumer = 9)] = "ContextConsumer"),
      (e[(e.ContextProvider = 10)] = "ContextProvider"),
      (e[(e.ForwardRef = 11)] = "ForwardRef"),
      (e[(e.Profiler = 12)] = "Profiler"),
      (e[(e.SuspenseComponent = 13)] = "SuspenseComponent"),
      (e[(e.MemoComponent = 14)] = "MemoComponent"),
      (e[(e.SimpleMemoComponent = 15)] = "SimpleMemoComponent"),
      (e[(e.LazyComponent = 16)] = "LazyComponent"),
      (e[(e.IncompleteClassComponent = 17)] = "IncompleteClassComponent"),
      (e[(e.DehydratedFragment = 18)] = "DehydratedFragment"),
      (e[(e.SuspenseListComponent = 19)] = "SuspenseListComponent"),
      (e[(e.ScopeComponent = 21)] = "ScopeComponent"),
      (e[(e.OffscreenComponent = 22)] = "OffscreenComponent"),
      (e[(e.LegacyHiddenComponent = 23)] = "LegacyHiddenComponent"),
      (e[(e.CacheComponent = 24)] = "CacheComponent"),
      (e[(e.TracingMarkerComponent = 25)] = "TracingMarkerComponent"),
      (e[(e.HostHoistable = 26)] = "HostHoistable"),
      (e[(e.HostSingleton = 27)] = "HostSingleton"),
      (e[(e.IncompleteFunctionComponent = 28)] = "IncompleteFunctionComponent"),
      (e[(e.Throw = 29)] = "Throw"),
      (e[(e.ViewTransitionComponent = 30)] = "ViewTransitionComponent"),
      (e[(e.ActivityComponent = 31)] = "ActivityComponent"));
  })(mt || (mt = {}));
  var gt = 100,
    ft = new WeakMap(),
    ht = 0;
    ...
    if (t != null) {
      if (t._debugOwner) {
        for (
          ;
          t._debugOwner &&
          ((n = t._debugOwner.memoizedProps) == null ? void 0 : n._fgT) != null;
        )
          t = t._debugOwner;
        return t._debugOwner ? Be(t._debugOwner) : void 0;
      }
      return (r = Hn(t)) != null ? r : void 0;
    }
  }
  var _n = new Set([0, 1, 11, 14, 15]);
  function Hn(e) {
    var o;
    let t = e.return,
      n = e,
      r = null;
    for (; t; ) {
      if (t.tag === 5 || t.child !== n || n.sibling != null) return r;
      if (_n.has((o = t.tag) != null ? o : -1)) {
        let a = Be(t);
        a &&
          /^.{5,}$/.test(a) &&
          !/^Primitive\./i.test(a) &&
  ...
  function Ct(e, t) {
    var l;
    let n = (l = e.tag) != null ? l : null,
      r = Be(e),
      o;
    e.stateNode instanceof Node && (o = t(e.stateNode));
    let a = e.memoizedProps ? $n(e.memoizedProps) : void 0,
      i = [],
      s = e.child;
    for (; s; ) {
      let c = Ct(s, t);
      (c && i.push(c), (s = s.sibling));
    }
    return { h2dId: o, name: r, fiberTag: n, props: a, children: i };
  }
  function $n(e) {
    let t = {};
    for (let [n, r] of Object.entries(e)) t[n] = Kn(r);
    return t;
  }
  function Kn(e) {
    if (
      ...
      return typeof e == "string" && e.length > gt
        ? { truncated: !0, value: e.slice(0, gt), originalLength: e.length }
        : e;
    if (typeof e == "object" || typeof e == "function") {
      let t = e,
        n = ft.get(t);
      return (n || ((n = `prop-ref-${++ht}`), ft.set(t, n)), { ref: n });
    }
  }
  function Be(e) {
    var t, n;
  ...
  function St(e, t) {
    ...
    for (let [r, o] of Object.entries(wt)) {
      let a = n.getPropertyValue(r);
      a && a.toLowerCase() !== o.toLowerCase() && t.setAttribute(Vn[r], a);
    }
    for (let r = 0; r < e.childNodes.length; r++)
      St(e.childNodes[r], t.childNodes[r]);
  }
  var wt = {
  ...
  function vt(e) {
    let t = 0,
      n = 0;
    if (e instanceof HTMLElement) ((t = e.offsetWidth), (n = e.offsetHeight));
    else if (e instanceof SVGSVGElement) {
      let r = getComputedStyle(e);
      ((t = parseFloat(r.width) || e.width.baseVal.value),
        (n = parseFloat(r.height) || e.height.baseVal.value));
  ...
  function Un(e) {
    ...
    return t.length === 0
      ? new DOMMatrix()
      : new DOMMatrix(
          `translate3d(${t[0]}, ${(n = t[1]) != null ? n : "0px"}, ${(r = t[2]) != null ? r : "0px"})`,
        );
  }
  function Gn(e) {
    var n, r;
    ...
    return new DOMMatrix(
      `scale3d(${t[0]}, ${(n = t[1]) != null ? n : t[0]}, ${(r = t[2]) != null ? r : 1})`,
    );
  }
  function Yn(e) {
    if (!e) return new DOMMatrix();
  ...
  function Xn(e) {
    return Math.abs(e.b) > 1e-6 || Math.abs(e.c) > 1e-6;
  }
  function Zn(e) {
    if (e.is2D) return new DOMMatrix([e.a, e.b, e.c, e.d, 0, 0]);
    let t = DOMMatrix.fromMatrix(e);
    return ((t.m41 = 0), (t.m42 = 0), (t.m43 = 0), t);
  }
  function Jn(e) {
    var o;
    let [t, n, r] =
      (o = e == null ? void 0 : e.split(" ")) != null
        ? o
        : ["0px", "0px", "0px"];
    return new DOMPoint().matrixTransform(
      new DOMMatrix(
        `translate3d(${t}, ${n != null ? n : "0px"}, ${r != null ? r : "0px"})`,
      ),
    );
  }
  function Et(e) {
    var t, n, r;
    if (!e.rotate && !e.scale && !e.transform && !e.translate) return null;
    try {
      let [o, a, i] =
          (n = (t = e.transformOrigin) == null ? void 0 : t.split(" ")) != null
            ? n
            : ["0px", "0px", "0px"],
        s = new DOMMatrix(
          `translate3d(${o}, ${a != null ? a : "0px"}, ${i != null ? i : "0px"})`,
        );
      return s
        .multiply(Un(e.translate))
        .multiply(Yn(e.rotate))
        .multiply(Gn(e.scale))
        .multiply(new DOMMatrix((r = e.transform) != null ? r : "none"))
        .multiply(s.inverse());
    } catch (o) {
      return null;
    }
  ...
  function kt(e, t) {
    if (!(!e && !t))
      return e ? (t ? e.multiply(t) : e) : t != null ? t : void 0;
  }
  function At(e, t, n) {
    let r = e.getBoundingClientRect(),
      { x: o, y: a, width: i, height: s } = r,
      l = vt(e),
      c = l.width,
      u = l.height;
    if (!n || !Xn(n))
      return { x: o, y: a, width: i, height: s, cssWidth: c, cssHeight: u };
    try {
      let d = Qn(e, t, n);
      return {
        x: o,
  ...
  function qn(e) {
    return new DOMPoint(e.x + e.width / 2, e.y + e.height / 2);
  }
  function Qn(e, t, n) {
    let r = e.getBoundingClientRect(),
      o = vt(e),
      ...
      c = qn(r),
      u = new DOMPoint(s.x - a / 2, s.y - i / 2),
      d = Zn(n),
      m = u.matrixTransform(d),
      g = Tt(l, d),
      y = Tt(g, new DOMMatrix().translate(c.x + m.x, c.y + m.y));
    return {
      p1: { x: y.p1.x, y: y.p1.y },
      p2: { x: y.p2.x, y: y.p2.y },
      p3: { x: y.p3.x, y: y.p3.y },
      p4: { x: y.p4.x, y: y.p4.y },
    };
  }
  function _e(e) {
    return C(this, null, function* () {
      ...
      for (let [n, r] of e.assets.entries())
        t[n] = De(R({}, r), { blob: yield Pt(r.blob) });
      return JSON.stringify(De(R({}, e), { assets: t, fonts: e.fonts }));
    });
  }
  function Pt(e) {
    return C(this, null, function* () {
  ...
  function He(e) {
    return C(this, null, function* () {
      return yield new Promise((t, n) => {
        ...
        r.readAsDataURL(
          new File([e], "", { type: "application/octet-stream" }),
        );
      });
    });
  }
  function $e(e) {
    return C(this, null, function* () {
      let t = yield He(new TextEncoder().encode(e)),
  ...
  var tr = {
    ...
    includeReactFiberTree: !1,
    captureDeclaredStyles: !1,
  };
  function jt(e, t) {
    return C(this, null, function* () {
      let n = R(R({}, tr), t),
        r = {
          captureDeclaredStyles: n.captureDeclaredStyles === !0,
          declaredStylesCache: n.captureDeclaredStyles ? new Map() : void 0,
        };
      (Ht(n), (Lt = 0));
      let o = new ge(n),
        a = new me();
      if (e instanceof Element) {
        yield Nt(Array.from(e.querySelectorAll("img")));
        let i = yield zt(e, o, a, n, r),
          s = yield o.getBlobMap(),
          l = a.getFonts(),
          { width: c, height: u } = e.getBoundingClientRect();
        if (!i || i.nodeType !== It.ELEMENT_NODE)
          throw new Error("Container node could not be serialized");
        let d = n.includeReactFiberTree
          ? { reactFiberTree: je(e, Dt) }
          : void 0;
        return {
          root: i,
        ...
        yield Nt(Array.from(e.images));
        let i = yield zt(e.documentElement, o, a, n, r),
          s = yield o.getBlobMap(),
          l = a.getFonts();
        if (!i || i.nodeType !== It.ELEMENT_NODE)
          throw new Error("Container node must have a body element");
        let c = n.includeReactFiberTree
          ? { reactFiberTree: je(e.documentElement, Dt) }
          : void 0;
        return {
  ...
  function zt(e, t, n, r, o) {
    var i;
    Ht(r);
    let a = (i = r.timeoutSignal) != null ? i : AbortSignal.timeout(er);
    return new Promise((s, l) => {
      (nr(() => s(Bt(e, t, n, void 0, o)), a),
        a.addEventListener(
          "abort",
          () =>
            l(
  ...
  function or(e, t, n, r, o) {
    ...
    if (u && u.length > 0) {
      if (
        ((b = u[0]) == null ? void 0 : b.type) === "text" &&
        e.childNodes.length === 1
      ) {
        let F = Ve(e.childNodes[0]);
        return ((F.sources = u), F);
      }
      l = Me(e);
    }
    let d = Rt(e),
      m =
        (o == null ? void 0 : o.captureDeclaredStyles) === !0 &&
        o.declaredStylesCache
          ? mr(e, o.declaredStylesCache)
          : {},
      g = Et(d),
      y = kt(r, g);
    e instanceof SVGElement
      ...
      : e instanceof HTMLCanvasElement
        ? (s = t.addCanvas(e))
        : e instanceof HTMLSlotElement && e.getRootNode() instanceof ShadowRoot
          ? (a = Ke(e.assignedNodes({ flatten: !0 }), t, n, y, o))
          : e.shadowRoot
            ? (a = Ke(e.shadowRoot.childNodes, t, n, y, o))
            : (a = Ke(e.childNodes, t, n, y, o));
    let S;
    (((e instanceof HTMLInputElement && rr.has(e.type)) ||
      e instanceof HTMLTextAreaElement) &&
      e.placeholder &&
      (S = { placeholder: Rt(e, "::placeholder") }),
      dt(e, d, t),
      ut(e, d, n));
    let w = At(e, d, y),
      f = {
        ...
        content: i,
        placeholderUrl: s,
        pseudoElementStyles: S,
        owningReactComponent: yt(e),
        sources: u,
        selectionSourceId: l,
        relativeTransform: g ? ar(g) : void 0,
      };
    return (Object.keys(m).length > 0 && (f.declaredStyles = m), f);
  }
  function ar(e) {
    return { a: e.a, b: e.b, c: e.c, d: e.d, e: 0, f: 0 };
  }
  function ir(e) {
    return !(
  ...
  function sr(e) {
    ...
    for (let { name: n, value: r } of e.attributes) {
      let o = n.toLowerCase();
      (yr.has(o) || o.startsWith("aria-")) && (t[n] = r);
    }
    return (
  ...
  var _t = [
    ...
    cr = 12;
  function ur(e) {
    for (let { cssKey: t } of _t) if (e.getPropertyValue(t).trim()) return !0;
    return !1;
  }
  function fe(e) {
    let t = [];
    for (let n = 0; n < e.length; n++) {
      ...
      if (r != null) {
        if (r.type === CSSRule.STYLE_RULE) {
          let o = r;
          ur(o.style) && t.push({ type: "style", rule: o });
          continue;
        }
        if (r.type === lr) {
          let o = r,
            a = fe(o.cssRules);
          a.length > 0 &&
            t.push({ type: "media", mediaText: o.media.mediaText, inner: a });
          continue;
        }
        if (r.type === cr) {
          let o = r;
          try {
            let a = globalThis.CSS;
            a != null &&
              a.supports(o.conditionText) &&
              t.push(...fe(o.cssRules));
          } catch (a) {}
          continue;
        }
        if ("cssRules" in r && r.cssRules) {
          let o = r;
          t.push(...fe(o.cssRules));
        }
      }
  ...
  function dr(e) {
    var n;
    let t = [];
    for (let r = 0; r < e.styleSheets.length; r++) {
      let o = e.styleSheets[r];
      if (o == null) continue;
      let a;
      try {
        a = (n = o.cssRules) != null ? n : o.rules;
      } catch (i) {
        continue;
      }
      a && t.push(...fe(a));
    }
    return { entries: t, matchMediaCache: new Map() };
  }
  function pr(e, t, n) {
    let r = {},
      { entries: o, matchMediaCache: a } = t;
    function i(s) {
      for (let l of s) {
        if (l.type === "media") {
          let u = a.get(l.mediaText);
          (u === void 0 &&
            ((u = n ? n.matchMedia(l.mediaText).matches : !1),
            a.set(l.mediaText, u)),
            u && i(l.inner));
          continue;
        }
        try {
          if (!e.matches(l.rule.selectorText)) continue;
        } catch (u) {
          continue;
        }
        let c = l.rule.style;
        for (let { jsKey: u, cssKey: d } of _t) {
          let m = c.getPropertyValue(d);
          m && (r[u] = m.trim());
        }
      }
    }
  ...
  function mr(e, t) {
    ...
    if (typeof n == "undefined" || !n.styleSheets) return {};
    let r = t.get(n);
    return (
      r || ((r = dr(n)), t.set(n, r)),
      pr(e, r, (o = n.defaultView) != null ? o : null)
    );
  }
  function Rt(e, t) {
    var a;
    let n = {},
      ...
      o = "computedStyleMap" in e && !t ? e.computedStyleMap() : null;
    for (let [i, s] of Object.entries(Mt)) {
      let l = r[i];
      l !== s && (n[i] = l);
    }
    for (let i of ["width", "height"]) {
      let s =
        (a = o == null ? void 0 : o.get(i)) == null ? void 0 : a.toString();
      s && s === Mt[i] && delete n[i];
    }
    for (let i of gr)
      n[i.width] == null && (delete n[i.style], delete n[i.color]);
    return (
  ...
  function Ve(e) {
    let a = fr(e),
      ...
      n = lt(a, ["lineCount"]),
      r = Array.isArray(e)
        ? e.map((i) => i.textContent || "").join("")
        : e.textContent || "",
      o = Array.isArray(e) ? (e.length === 1 ? e[0] : null) : e;
    return {
  ...
  function fr(e) {
    ...
    if (Array.isArray(e)) {
      let c = e[0],
        u = e[e.length - 1];
      (t.setStart(c, 0), t.setEnd(u, u.length));
    } else t.selectNode(e);
    let { x: n, y: r, width: o, height: a } = t.getBoundingClientRect(),
      i =
        t.commonAncestorContainer instanceof HTMLElement
          ? window
              .getComputedStyle(t.commonAncestorContainer)
              .writingMode.startsWith("vertical")
          : !1,
      s = Array.from(t.getClientRects()).filter(
        (c) => c.width > 0 && c.height > 0,
      ),
      l = i
        ? new Set(s.map((c) => Math.round(c.left))).size
        : new Set(s.map((c) => Math.round(c.top))).size;
    return (t.detach(), { x: n, y: r, width: o, height: a, lineCount: l });
  }
  function* hr(e) {
  ...
  function Cr(e) {
    try {
      ...
      return br.some((r) => n === r || n.endsWith(`.${r}`));
    } catch (t) {
      return !1;
    }
  }
  function Fr() {
    ...
    for (let c of n) {
      let [u, d] = c.split("=");
      if (u === "figmacapture" && d) r = decodeURIComponent(d);
      else if (u === "figmaendpoint" && d) o = decodeURIComponent(d);
      else if (u === "figmadelay" && d) {
        let m = parseInt(decodeURIComponent(d), 10);
        !isNaN(m) && m >= 0 && (a = m);
      } else
        u === "figmaselector" && d
  ...
  function $t({
    ...
    (() =>
      C(this, null, function* () {
        var l;
        if (r.selector && !(yield xr(r.selector))) {
          console.error(
            `[Figma Capture] Timeout waiting for selector: ${r.selector}`,
          );
          return;
        }
        let s = (l = r.delay) != null ? l : 0;
        a
          ? o && a && e(o, a, r.selector, s, r.logVerbose)
          : t(r.selector, s, r.logVerbose);
      }))();
  }
  var M = class extends Error {
    constructor(n, r) {
      super(n);
      P(this, "translationKey");
  ...
  function v(e) {
    let t = Tr();
    return he[t] && he[t][e] ? he[t][e] : he.en[e] || e;
  }
  var p = {
    bg: "#2c2c2c",
  ...
  function ne(e, t, n = !1) {
    ...
    let o = document.createElementNS(Wt, "svg");
    ...
    let a = document.createElementNS(Wt, "path");
    return (
      a.setAttribute("d", r.path),
      a.setAttribute("fill", t),
      r.fillRule &&
        (a.setAttribute("fill-rule", r.fillRule),
        a.setAttribute("clip-rule", r.fillRule)),
      o.appendChild(a),
      o
    );
  }
  function Ue(e, t, n = "primary", r = !1, o = !1) {
    ...
    i.textContent = e;
    let s = n === "primary",
      l = s ? p.brandHover : p.secondaryHover,
      c = s ? p.brandPressed : p.secondaryPressed,
      u = s ? p.brand : "transparent";
    return (
      x(i, {
        display: "inline-flex",
        alignItems: "center",
        ...
        padding: "0 8px",
        border: s ? "none" : `1px solid ${p.border}`,
        borderRadius: p.buttonBorderRadius,
        background: u,
        color: s ? p.textOnBrand : p.text,
        fontFamily: "inherit",
        fontSize: "inherit",
        fontWeight: "inherit",
        lineHeight: "inherit",
      ...
      r || o
        ? (i.disabled = !0)
        : ((i.onmouseenter = () => (i.style.background = l)),
          (i.onmouseleave = () => (i.style.background = u)),
          (i.onmousedown = () => (i.style.background = c)),
          (i.onmouseup = () => (i.style.background = l)),
          (i.onclick = t)),
      a.appendChild(i),
      a
    );
  }
  var Vt = "figma.capturePreferences";
  function Ge() {
    try {
  ...
  function Xe() {
    if (!Fe) return;
    let { cleanup: e, timeoutId: t } = Fe;
    (clearTimeout(t), e());
  }
  var Ce = 300,
    Ye = "cubic-bezier(0.15, 1, 0.4, 1)";
  function Er(e) {
  ...
  function re(e, t, n, r) {
    ...
    let o = e.getBoundingClientRect().width,
      ...
      i = [];
    for (let f of Array.from(e.children))
      i.push({
        el: f,
        rect: f.getBoundingClientRect(),
        role: f.getAttribute("data-toolbar-role"),
      });
    let s = (w = r == null ? void 0 : r.minWidth) != null ? w : "";
    ((e.style.minWidth = s),
    ...
    ((e.style.transition = "none"),
      ...
      (e.style.width = `${o}px`));
    let c = [];
    for (let { el: f, rect: b, role: F } of i) {
      ...
      (x(E, {
        ...
        E.appendChild(f),
        F && E.setAttribute("data-exit-role", F),
        e.appendChild(E),
        c.push(E));
    }
    let u = new Set(c),
      d = [];
    for (let f of Array.from(e.children)) u.has(f) || d.push(f);
    for (let f of d) {
      let b = f.getAttribute("data-toolbar-role"),
        F = kr(b);
      ((f.style.transition = "none"),
        (f.style.opacity = "0"),
        F && (f.style.transform = F));
    }
    e.offsetWidth;
    let m = `opacity ${Ce}ms ${Ye}, transform ${Ce}ms ${Ye}`;
    ((e.style.transition = `width ${Ce}ms ${Ye}`), (e.style.width = `${l}px`));
    for (let f of c) {
      let b = f.getAttribute("data-exit-role"),
        F = Er(b);
      ((f.style.transition = m),
        (f.style.opacity = "0"),
        F && (f.style.transform = F));
    }
    for (let f of d)
    ...
    let g = !1,
      ...
      S = setTimeout(y, Ce + 50);
    (e.addEventListener("transitionend", function f(b) {
      b.propertyName === "width" &&
        b.target === e &&
        (e.removeEventListener("transitionend", f), clearTimeout(S), y());
    }),
      (Fe = { overlays: c, newChildren: d, cleanup: y, timeoutId: S }));
  }
  var Ar = "__figma_capture_toolbar_host__",
    Gt = 200,
    Pr = "16px",
    Ir = "16px",
    I = null,
  ...
  function zr() {
    if (!G || !A) return;
    let e = Qe();
    (et(A, e), (A.style.minWidth = e ? "265px" : "490px"));
  }
  function tn(e) {
    if (e.key === "Escape" && V) {
      let t = Date.now();
      t - Yt < Dr ? (e.preventDefault(), e.stopPropagation(), V()) : (Yt = t);
    } else be(e) && G && U && (e.preventDefault(), e.stopPropagation(), U());
  }
  function Rr() {
    let e = Ge();
  ...
  function tt(e, t) {
    t === "top"
      ? ((e.style.top = Pr), (e.style.bottom = ""))
      : ((e.style.top = ""), (e.style.bottom = Ir));
  }
    ...
    let i = 400,
      ...
      y = (S) => {
        ...
        ((d += Fn * w),
          ...
          (e.style.bottom = ""));
        let Sn = Math.abs(f) < 0.5 && Math.abs(m) < 10,
          wn = Math.abs(z) < 0.5 && Math.abs(d) < 10;
        Sn && wn
          ? (tt(e, ie),
            (e.style.left = "50%"),
            (e.style.transform = "translateX(-50%)"),
  ...
  function Xt(e) {
    ...
    let n =
        "touches" in e
          ? (s = (i = e.touches[0]) == null ? void 0 : i.clientX) != null
            ? s
            : 0
          : e.clientX,
      r =
        "touches" in e
          ? (c = (l = e.touches[0]) == null ? void 0 : l.clientY) != null
            ? c
            : 0
          : e.clientY,
  ...
  function we(e) {
    ...
    let t =
        "touches" in e
          ? (g = (m = e.touches[0]) == null ? void 0 : m.clientX) != null
            ? g
            : 0
          : e.clientX,
      n =
        "touches" in e
          ? (S = (y = e.touches[0]) == null ? void 0 : y.clientY) != null
            ? S
            : 0
          : e.clientY,
      r = t - Zt,
      ...
      c = i;
    if (i < 0) c = i * 0.3;
    else if (i > window.innerHeight - 40) {
      let w = i - (window.innerHeight - 40);
      c = window.innerHeight - 40 + w * 0.3;
    } else c = Math.max(s, Math.min(l, i));
    ((qe = a), (Se = c), (T.style.left = `${a}px`), (T.style.top = `${c}px`));
  ...
  function jr(e) {
    (e.addEventListener("mousedown", Xt),
      ...
      e.addEventListener("touchstart", Xt, { passive: !1 }),
      document.addEventListener("touchmove", we, { passive: !1 }),
      document.addEventListener("touchend", xe),
      window.addEventListener("resize", en),
      document.addEventListener("keydown", tn, !0));
  }
  function Br() {
    (document.removeEventListener("mousemove", we),
      ...
      document.removeEventListener("touchend", xe),
      window.removeEventListener("resize", en),
      document.removeEventListener("keydown", tn, !0),
      W !== null && (cancelAnimationFrame(W), (W = null)));
  }
  function J() {
    if ((_ && (clearTimeout(_), (_ = null)), I && K && A))
      return (
        (A.style.animation = "none"),
        { host: I, shadowRoot: K, toolbar: A }
      );
    ((ie = Rr()),
      (I = document.createElement("div")),
      (I.id = Ar),
      (K = I.attachShadow({ mode: "closed" })));
  ...
  function L() {
    ((G = !1),
      ...
      A &&
        I &&
        (x(A, { animation: `fade ${Gt}ms ease-out forwards` }),
        (_ = setTimeout(() => {
          (I &&
            (Br(), I.remove(), (I = null), (K = null), (A = null), (T = null)),
            (_ = null));
        }, Gt))));
  }
  ...
  function Y(e) {
    var u, d;
    ((G = !1),
      (V = (d = (u = e.onEscape) != null ? u : e.onClose) != null ? d : null),
      (U = null));
    let t = !A,
      { toolbar: n, shadowRoot: r } = J(),
      o = !!e.icon,
      a = e.buttons || (e.button ? [e.button] : []),
      i = a.length > 0,
      s = !!e.onClose,
      l = [];
    if (e.icon) {
      let m = {
          spinner: { name: "icon.24.spinner", color: p.text, isSpinner: !0 },
          check: { name: "icon.24.check", color: p.success, isSpinner: !1 },
          error: { name: "icon.24.warning", color: p.error, isSpinner: !1 },
        },
        { name: g, color: y, isSpinner: S } = m[e.icon],
        w = ne(g, y, S);
      (w.setAttribute("data-toolbar-role", "icon"), l.push(w));
    }
    let c = _r(e.message, !o, !i && !s);
    (c.setAttribute("data-toolbar-role", "message"), l.push(c));
    for (let m of a) {
      let g = Ue(m.text, m.onClick, m.variant, m.disabled, m.isLoading);
      (g.setAttribute("data-toolbar-role", "button"), l.push(g));
    }
    if (e.onClose) {
      let m = rt(e.onClose);
      (m.setAttribute("data-toolbar-role", "button"), l.push(m));
    }
    return (t ? n.replaceChildren(...l) : re(n, r, l), n);
  }
  function le(e) {
    Y({
      icon: "spinner",
      message: v("capturing"),
      button: e
        ? { text: v("cancel"), onClick: e, variant: "secondary" }
        : void 0,
      onEscape: e,
    });
  }
  function q(e) {
    Y({
      icon: "check",
      message: v("captureSubmitted"),
      button: {
        text: v("openInFigma"),
        onClick: () => {
          (window.open(e != null ? e : "https://www.figma.com", "_blank"), L());
        },
        variant: "secondary",
      },
    });
  ...
  function ve() {
    Y({ icon: "spinner", message: v("capturingForClipboard") });
  }
  function ce(e) {
    let t;
    (e instanceof M
      ? (t = v(e.translationKey))
      : e instanceof Error
        ? (t = e.message)
        : (t = e || v("error")),
      Y({ icon: "error", message: t, onClose: () => L() }));
  }
  function ae(e, t, n) {
    ...
    return (
      (a.textContent = t),
      a.setAttribute("data-toolbar-label", ""),
      x(a, { marginLeft: "4px" }),
      r.appendChild(o),
      r.appendChild(a),
      x(r, {
      ...
      (r.onmouseenter = () => (r.style.background = p.secondaryHover)),
      (r.onmouseleave = () => (r.style.background = "transparent")),
      (r.onmousedown = () => (r.style.background = p.secondaryPressed)),
      (r.onmouseup = () => (r.style.background = p.secondaryHover)),
      (r.onclick = n),
      r
    );
  }
  ...
  function rt(e) {
    ...
    ((t.type = "button"), t.setAttribute("aria-label", v("cancel")));
    let n = ne("icon.24.close.large", p.text);
    return (
      t.appendChild(n),
      x(t, {
        display: "inline-flex",
      ...
      (t.onmouseenter = () => (t.style.background = p.secondaryHover)),
      (t.onmouseleave = () => (t.style.background = "transparent")),
      (t.onmousedown = () => (t.style.background = p.secondaryPressed)),
      (t.onmouseup = () => (t.style.background = p.secondaryHover)),
      (t.onclick = e),
      t
    );
  }
  function Q(e) {
    ((G = !0), (V = e.onClose), (U = e.onCapturePage));
    let { toolbar: t, shadowRoot: n } = J(),
      r = [],
      o = document.createElement("span");
    ((o.textContent = v("sendToFigma")),
    ...
    (a.setAttribute("data-toolbar-role", "button"),
      ...
      a.appendChild(ae("icon.24.browser", v("capturePage"), e.onCapturePage)),
      a.appendChild(
        ae("icon.24.interaction.click", v("selectElement"), e.onSelectElement),
      ),
      a.appendChild(ae("icon.24.new.tab", v("openFile"), e.onOpenFile)),
      r.push(a),
      r.push(Te()));
    let i = rt(e.onClose);
    (i.setAttribute("data-toolbar-role", "button"), r.push(i));
    let s = Qe();
    (et(a, s), re(t, n, r, { minWidth: s ? "265px" : "490px" }));
  }
  function nn(e) {
    ((G = !0), (V = e.onClose), (U = e.onCapturePage));
    let { toolbar: t, shadowRoot: n } = J(),
      r = [],
      o = document.createElement("span");
    ((o.textContent = v("copyToClipboard")),
      o.setAttribute("data-toolbar-role", "message"),
      x(o, {
        textAlign: "left",
        padding: "0 12px 0 4px",
  ...
  function rn(e) {
    ...
    let { toolbar: t, shadowRoot: n } = J(),
      r = [],
      o = ne("icon.24.interaction.click", p.text);
    (o.setAttribute("data-toolbar-role", "icon"), r.push(o));
    let a = document.createElement("span");
    ((a.textContent = v("selectElementToCapture")),
      a.setAttribute("data-toolbar-role", "message"),
      x(a, {
        flexGrow: "1",
        textAlign: "left",
        padding: "0 8px",
      ...
      r.push(a));
    let i = Ue(v("cancel"), e, "secondary");
    (i.setAttribute("data-toolbar-role", "button"),
      r.push(i),
      re(t, n, r, { minWidth: "265px" }));
  }
  var N = null,
    k = null,
    Z = null,
  ...
  function Hr(e) {
    ...
    for (; n && n !== document.body && n !== document.documentElement; ) {
      ...
      if (o) {
        let a = Array.from(o.children).filter((i) => i.tagName === n.tagName);
        if (a.length > 1) {
          let i = a.indexOf(n) + 1;
          r += `:nth-of-type(${i})`;
        }
  ...
  function Kr() {
    ...
    ((X = document.createElement("style")),
      (X.id = "__figma_capture_cursor_style__"),
      (X.textContent = "* { cursor: crosshair !important; }"),
  ...
  function Wr(e, t) {
    let o,
      a = window.innerHeight - e.bottom - 8,
      i = e.top - 56 - 8;
    a >= t.height
      ? (o = e.bottom + 8)
      : i >= t.height
    ...
    let s = e.left;
    return (
      s + t.width > window.innerWidth - 8 &&
        (s = window.innerWidth - t.width - 8),
      s < 8 && (s = 8),
      { top: o, left: s }
    );
  }
  function Vr(e) {
    if (!N || !k) return;
    if (!e) {
      ((N.style.display = "none"), (k.style.display = "none"), (Z = null));
      return;
    }
  ...
  function ln(e) {
    nt(e.target) || (e.preventDefault(), e.stopPropagation(), on());
  }
  function cn(e) {
    e.key === "Escape"
      ? (e.preventDefault(), an())
      : be(e) && (e.preventDefault(), on());
  }
  var ee = "cubic-bezier(0.15, 1, 0.4, 1)",
    ot = 300,
    Ur = 600,
    Ee = 300;
  function Gr(e) {
    ((e.style.transition = `border ${ot}ms ${ee}, box-shadow ${ot}ms ${ee}`),
      (e.style.border = `2px solid ${p.brand}`),
      (e.style.boxShadow = `0 0 0 4px ${p.brandBg}`),
      setTimeout(() => {
        ((e.style.transition = `box-shadow ${Ur}ms ${ee}`),
          (e.style.boxShadow = `0 0 0 0px ${p.brandBg}`));
      }, ot));
  }
  function un() {
    (document.removeEventListener("mousemove", sn, !0),
      document.removeEventListener("click", ln, !0),
      document.removeEventListener("keydown", cn, !0),
      X && (X.remove(), (X = null)));
  }
  function dn() {
    (un(),
  ...
  function Ae(e, t) {
    (dn(),
      ...
      (ke = t),
      Kr(),
      document.addEventListener("mousemove", sn, !0),
      document.addEventListener("click", ln, !0),
      document.addEventListener("keydown", cn, !0));
  }
  function j() {
    if (N) {
      let e = N;
      ((N = null),
        (e.style.transition = `opacity ${Ee}ms ${ee}, border-color ${Ee}ms ${ee}, box-shadow ${Ee}ms ${ee}`),
        (e.style.opacity = "0"),
        e.addEventListener("transitionend", () => e.remove(), { once: !0 }),
        setTimeout(() => e.remove(), Ee + 50));
    }
    k && (k.remove(), (k = null));
  }
  var Yr = {
  ...
  function Xr(e) {
    let t = Yr[e.code];
    return new M(e.message, t);
  }
  var pn = "[Figma Capture]",
    mn = 6e4,
    h = {
      verbose: !1,
      log: (...e) => {
        h.verbose && console.log(pn, ...e);
      },
      error: (...e) => {
        h.verbose && console.error(pn, ...e);
      },
    };
  function B(e) {
  ...
  function Zr() {
    return C(this, null, function* () {
      document.readyState === "loading" &&
        (h.log("Waiting for DOM to be ready..."),
        yield new Promise((e) =>
  ...
  function de(e = "body") {
    return C(this, null, function* () {
      ...
      h.log("Serializing DOM...");
      let n;
      try {
        let a = Jr(1e4);
        n = yield jt(t, { timeoutSignal: a });
      } catch (a) {
        throw a instanceof $ ? Xr(a) : a;
      }
      h.log("Converting to JSON...");
      let r = yield _e(n),
        o = Math.round(r.length / 1024);
      return (h.log(`Payload size: ${o} KB`), r);
    });
  }
  function hn(e, t, n, r = 0) {
    return C(this, null, function* () {
      h.log("Sending captures to Figma...");
      let o = Math.round(e.length / 1024);
      h.log(`Sending capture, total size: ${o} KB`);
      let a = n.replace(/\/capture\/[^/]+\/submit/, `/capture/${t}/submit`),
        i = new AbortController(),
        s = setTimeout(() => i.abort(), mn);
      try {
        let l = yield fetch(a, {
          method: "POST",
          ...
          try {
            ...
            g.errorCode
              ? ((m = {
                ...
                (d = m ? v(m) : g.errorCode))
              : (d = g.error || l.statusText);
          } catch (g) {
            d = yield l.text().catch(() => l.statusText);
          }
          throw (
            h.error(`Server error (${l.status}): ${d}`),
            m ? new M(d, m) : new Error(d)
          );
        }
        let c = yield l.json();
        if (c.error)
          throw (h.error("Capture failed:", c.error), new Error(c.error));
        h.log("Success! Page has been captured and sent to Figma.");
        let u = c.claimUrl || c.fileUrl;
        return (
          u && h.log(`Open your file: ${u}`),
          { claimUrl: u, nextCaptureId: c.nextCaptureId }
        );
      } catch (l) {
        throw (
          clearTimeout(s),
          l instanceof Error && l.name === "AbortError"
            ? new M(
                `Request timed out after ${mn / 1e3} seconds`,
                "errorTimeout",
              )
            : l
        );
  ...
  function gn() {
    return C(this, null, function* () {
      document.hasFocus() ||
        (h.log("Document not focused, waiting for focus..."),
        yield new Promise((e) => {
          window.addEventListener("focus", () => e(), { once: !0 });
        }),
        h.log("Document focused, proceeding with clipboard copy"));
    });
  }
  function at(e) {
    return C(this, null, function* () {
      ...
      if (
        ...
        let n = yield $e(e);
        yield gn();
        let r = new ClipboardItem({ "text/html": n });
        yield navigator.clipboard.write([r]);
      } else (yield gn(), yield navigator.clipboard.writeText(e));
    });
  }
  function yn(e) {
    let t,
      ...
      r = null,
      o = () => {
        (r && (clearTimeout(r), (r = null)), L(), t({ success: !0 }));
      },
      a = () => {
        (r && (clearTimeout(r), (r = null)),
          nn({
            onCapturePage: () => void s(),
            onSelectElement: l,
            onClose: o,
          }));
      },
      i = () => {
        (r && (clearTimeout(r), (r = null)),
          Y({ icon: "check", message: v("clipboardSuccess"), onClose: a }),
          (r = setTimeout(a, 3e3)));
      },
      s = () =>
        C(this, null, function* () {
          ...
          try {
            ...
            let u = B(c);
            (h.error("Clipboard capture error:", u),
              ce(u),
              t({ success: !1, error: u }));
          }
        }),
          ...
          (c) =>
            C(this, null, function* () {
              ...
              try {
                ...
                let d = B(u);
                (h.error("Clipboard capture error:", d),
                  j(),
                  ce(d),
                  t({ success: !1, error: d }));
              }
    ...
    return { promise: n, showSuccess: i, showClipboardBar: a, done: o };
  }
  function O(e) {
    let t = v("sendToFigmaFailed");
    e instanceof M && (t = v(e.translationKey));
    let { promise: n, showClipboardBar: r, done: o } = yn("body");
    return (
      Y({
        icon: "error",
        message: t,
        button: { text: v("copyInstead"), onClick: r, variant: "secondary" },
        onClose: o,
      }),
      n
    );
  }
  function bn(e, t, n = "body", r, o) {
    return C(this, null, function* () {
      ((h.verbose = o != null ? o : !1),
        h.log("Starting streaming multi-capture flow...", {
          captureId: e,
          selector: n,
          delayMs: r,
        }));
      let a = e,
        ...
        c,
        u = () => {
          ((l = !0), h.log("Capture cancelled by user"), L());
        },
        d = (m) =>
          C(this, null, function* () {
            let g = yield de(m),
              y = i;
            if ((i++, l)) return { success: !1, error: "cancelled" };
            let S = yield hn(g, a, t, y);
            return l
              ? { success: !1, error: "cancelled" }
              : (S.nextCaptureId &&
                  ((a = S.nextCaptureId),
                  h.log("Updated captureId for next submission:", a)),
                {
                  success: !0,
                  claimUrl: S.claimUrl,
                  nextCaptureId: S.nextCaptureId,
                });
          });
      try {
        if (
          ...
          r &&
            r > 0 &&
            (h.log(`Waiting ${r}ms before capture...`),
            yield new Promise((g) => setTimeout(g, r))),
          l)
        )
        ...
        return m.success
          ? ((c = m.claimUrl),
            h.log("First capture submitted", { captureCount: i, claimUrl: c }),
            yield new Promise((g) => {
              let y = null,
                S = () => {
                  (y && (clearTimeout(y), (y = null)), L(), g({ success: !0 }));
                },
                w = () =>
                  C(this, null, function* () {
                    var F;
                    if (!s) {
                      ...
                      try {
                        ...
                        if (!E.success) {
                          if (l) {
                            g({ success: !1, cancelled: !0 });
                            return;
                          }
                          ((s = !1), O(E.error).then(g));
                          return;
                        }
                        ((c = (F = E.claimUrl) != null ? F : c),
                          (s = !1),
                          h.log("Additional capture submitted", {
                            captureCount: i,
                          }),
                          q(c),
                          (y = setTimeout(() => {
                            Q({
                              onCapturePage: () => void w(),
                              onSelectElement: f,
                              onOpenFile: b,
                              onClose: S,
                            });
                        ...
                        let z = B(E);
                        (h.error("Capture error:", z), (s = !1), O(E).then(g));
                      }
                    }
                  }),
                f = () => {
                          ...
                          if (!s) {
                            ...
                            try {
                              ...
                              if (!z.success) {
                                ...
                                ((s = !1), j(), O(z.error).then(g));
                                return;
                              }
                              ((c = (E = z.claimUrl) != null ? E : c),
                                (s = !1),
                                h.log("Element capture submitted", {
                                  captureCount: i,
                                  selector: F,
                                }),
                                q(c),
        ...
        if (l) return { success: !1, cancelled: !0 };
        let g = B(m);
        return (h.error("Error:", g), yield O(m));
      }
    });
  }
  function qr(e, t, n) {
    return C(this, null, function* () {
      ((h.verbose = n != null ? n : !1),
        h.log("Starting multi-capture selection flow...", { captureId: e }));
      let r = e,
        o = 0,
        a = !1,
        i = !1,
        s,
        l = () => {
          ((i = !0), h.log("Capture cancelled by user"), L());
        },
        c = (u) =>
          C(this, null, function* () {
            let d = yield de(u),
              m = o;
            if ((o++, i)) return { success: !1, error: "cancelled" };
            let g = yield hn(d, r, t, m);
            return i
              ? { success: !1, error: "cancelled" }
              : (g.nextCaptureId &&
                  ((r = g.nextCaptureId),
                  h.log("Updated captureId for next submission:", r)),
                {
                  success: !0,
                  claimUrl: g.claimUrl,
                  nextCaptureId: g.nextCaptureId,
                });
          });
      return new Promise((u) => {
        let d = null,
          m = () => {
            (d && (clearTimeout(d), (d = null)), L(), u({ success: !0 }));
          },
          g = () => {
              ...
              if (!a) {
                ...
                try {
                  ...
                  if (!b.success) {
                    ...
                    ((a = !1), O(b.error).then(u));
                    return;
                  }
                  ((s = (f = b.claimUrl) != null ? f : s),
                    (a = !1),
                    h.log("Additional capture submitted", { captureCount: o }),
                    q(s),
                    (d = setTimeout(y, 3e3)));
                } catch (b) {
                  if (i) {
                  ...
                  let F = B(b);
                  (h.error("Capture error:", F), (a = !1), O(b).then(u));
                }
              }
            }),
          w = () => {
                    ...
                    if (!a) {
                      ...
                      try {
                        ...
                        if (!F.success) {
                          ...
                          ((a = !1), j(), O(F.error).then(u));
                          return;
                        }
                        ((s = (b = F.claimUrl) != null ? b : s),
                          (a = !1),
                          h.log("Element capture submitted", {
                            captureCount: o,
                            selector: f,
  ...
  function fn(e) {
    return C(this, null, function* () {
      ...
      if (((h.verbose = o), n && !t))
        return (
          h.error("captureId is required for file mode"),
          { success: !1, error: "captureId is required for file mode" }
        );
      if (n) return bn(t, n, r, a);
      (h.log("Starting clipboard capture...", { selector: r }),
        ve(),
        a &&
          a > 0 &&
          (h.log(`Waiting ${a}ms before capture...`),
          yield new Promise((l) => setTimeout(l, a))));
      try {
        let l = yield de(r);
        h.log("Copying to clipboard...");
        try {
          (yield at(l), h.log("Success! Capture copied to clipboard."));
        } catch (c) {
          let u = B(c);
          return (
            h.error("Clipboard error:", u),
            ce(`Clipboard error: ${u}`),
            { success: !1, error: `Clipboard error: ${u}` }
          );
        }
      } catch (l) {
        let c = B(l);
        return (
          ...
          c.includes("Element not found")
            ? L()
            : ce(l instanceof Error ? l : c),
          { success: !1, error: c }
        );
      }
      let { promise: i, showSuccess: s } = yn(r);
      return (s(), i);
    });
  }
  typeof window != "undefined" &&
    (window.figma || (window.figma = {}),
    (window.figma.captureForDesign = fn),
    $t({
      startMultiCaptureAutomaticFlow: bn,
      startClipboardFlow: (e, t, n) =>
        fn({ selector: e, delayMs: t, verbose: n }),
      startMultiCaptureSelectionFlow: qr,
    }));
})();
