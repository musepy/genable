...
Each node object MUST follow this structure:
{
  ...
  "props": {
    ...
    "padding": 16,         // Or explicitly "paddingTop", "paddingRight", "paddingBottom", "paddingLeft"
    "itemSpacing": 12,
    "fills": ["#FFFFFF"],
    "cornerRadius": 8,
...
- itemSpacing (not "spacing" or "gap")
- layoutMode (not "layout")
- layoutPositioning (AUTO/ABSOLUTE)
- paddingTop, paddingRight, paddingBottom, paddingLeft (or "padding" shortcut)
