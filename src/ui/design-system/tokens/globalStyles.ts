...
export const globalStyles = `
  ...
  * { box-sizing: border-box; }
  ...
  /* --- Settings-scoped dev-disclosure (smaller than the global one) --- */
  .settings-body .dev-disclosure {
    padding: 0 22px;
    margin-top: 22px;
  }
  .settings-body .dev-disclosure .dd-toggle {
    display: flex;
    align-items: center;
    gap: 4px;
    font-size: 11px;
  ...
  .settings-body .dev-disclosure .dd-toggle:hover { opacity: 1; color: var(--gray-12); }

  .settings-body .dev-disclosure + .footer-b { margin-top: 8px; }
